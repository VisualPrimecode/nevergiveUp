...
from .views import form_del_Publicacion,lista_mod_Publicaciones,form_mod_Publicacion,form_Publicacion,MenuPrincipal,registro,RecuperarClave,publicaciones_por_categoria,crear_publicacion,listadoPublicaciones
urlpatterns = [
