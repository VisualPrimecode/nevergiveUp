...
from .serializers import PublicacionSerializer,form_publicacionSerializers,UserSerializers
...
def lista_Publicaciones(request):
    if request.method == 'GET':
        ...
        serializer = form_publicacionSerializers(publicacion, many=True)
        return Response(serializer.data)
    elif request.method == 'POST':
        data=JSONParser().parse(request)
        serializer = form_publicacionSerializers(data = data)
